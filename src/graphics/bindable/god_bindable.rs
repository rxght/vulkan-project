    ...
    BP: Fn(&mut PipelineBuilder, &mut u32),
{
    ...
    fn bind(&self, gfx: &Graphics, builder: &mut Builder, pipeline_layout: Arc<PipelineLayout> )
    {
...
impl<BindClosure, BindToPipelineClosure> GodBindable<BindClosure, BindToPipelineClosure>
    ...
    BindToPipelineClosure: Fn(&mut PipelineBuilder, &mut u32),
{
    pub fn new(bind_closure: BindClosure, bind_to_pipeline_closure: BindToPipelineClosure) -> Arc<Self>
    {
        Arc::new(Self {
