...
use vulkano::{buffer::BufferContents, pipeline::graphics::{input_assembly::{InputAssemblyState, PrimitiveTopology}, vertex_input}, shader::ShaderStages};

use crate::graphics::{bindable::{self, IndexBuffer, PushConstant, MutableVertexBuffer}, drawable::{DrawableEntry, GenericDrawable}, pipeline::PipelineBuilder, shaders::{frag_solid_white, vert_cartesian_2d}, Graphics};
...
impl Bezier
{
    pub fn new(gfx: &mut Graphics, p_0: Vector2<f32>, p_1: Vector2<f32>, p_2: Vector2<f32>) -> Self {
